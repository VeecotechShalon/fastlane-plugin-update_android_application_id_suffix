...
require 'fastlane/plugin/update_android_application_id_suffix/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-update_android_application_id_suffix'
  spec.version       = Fastlane::UpdateAndroidApplicationIdSuffix::VERSION
  spec.author        = 'Shalon Teoh'
